...
// ***********************************************************
// Precondition: Function recieves two vectors of values and ofstream
// PostCondition: Function writes the standard deviation to the file
// Summary: Function calculates the standard deviation from the values within given the vector and writes the two answers to the file
// ***********************************************************
...
// ***********************************************************
// Precondition: Function recieves a vectors and outfile stream
// Postcondition: Function finds the number of zero crossings and writes them to the file
// Summary: Function is used to find the number of zero crossings and writes the results to the output file
// ***********************************************************
